...
import { fetchBuyerPolicy, updateBuyerPolicy } from '../../../store/TermsandConditionPrivacyPolicy/PrivacyPolicySlice';
import Alert from '../../ui/alert/Alert';
import Skeleton from 'react-loading-skeleton';
import 'react-loading-skeleton/dist/skeleton.css';


type BuyerPrivacyPolicyForm = {
  title: string;
  description: string;
};


const BuyerPrivacyPolicyForm = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await dispatch(
        updateBuyerPolicy({ id: policyData._id, payload: { title, description } })
      ).unwrap();

      setAlertType('success');
      setAlertMessage('Buyer Privacy Policy updated successfully.');
      setShowAlert(true);
...
export default BuyerPrivacyPolicyForm;
