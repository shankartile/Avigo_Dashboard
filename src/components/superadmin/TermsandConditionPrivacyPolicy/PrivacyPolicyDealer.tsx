...
import { fetchDealerPolicy, updateDealerPolicy } from '../../../store/TermsandConditionPrivacyPolicy/PrivacyPolicySlice';
import Alert from '../../ui/alert/Alert';
import Skeleton from 'react-loading-skeleton';
import 'react-loading-skeleton/dist/skeleton.css';


type DealerPrivacyPolicyForm = {
  title: string;
  description: string;
};
...
const DealerPrivacyPolicyForm = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await dispatch(
        updateDealerPolicy({ id: policyData._id, payload: { title, description } })
      ).unwrap();

      setAlertType('success');
      setAlertMessage('Dealer Privacy Policy updated successfully.');
      setShowAlert(true);
...
export default DealerPrivacyPolicyForm;
