...
import { fetchDealerTerms, updateDealerTerms } from '../../../store/TermsandConditionPrivacyPolicy/TermsandConditionSlice';
...
const DealerTermsConditionForm = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await dispatch(
        updateDealerTerms({ id: termsData._id, payload: { title, description } })
      ).unwrap();

      setAlertType('success');
      setAlertMessage('Dealer Terms and Condition updated successfully.');
      setShowAlert(true);
...
export default DealerTermsConditionForm;
