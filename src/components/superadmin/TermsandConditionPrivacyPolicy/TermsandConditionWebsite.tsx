...
import { fetchwebsiteTerms, updatewebsiteTerms } from '../../../store/TermsandConditionPrivacyPolicy/TermsandConditionSlice';
...
type WebsiteTermsConditionForm = {
...
const WebsiteTermsConditionForm = () => {
  ...
  if (loading) return; // Prevent multiple submissions
    ...
    try {
      ...
      await dispatch(
        updatewebsiteTerms({ id: termsData._id, payload: { title, description } })
      ).unwrap();

      setAlertType('success');
      setAlertMessage('Website Terms and Condition updated successfully.');
      setShowAlert(true);
...
export default WebsiteTermsConditionForm;
