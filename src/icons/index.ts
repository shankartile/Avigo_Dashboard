...
import {ReactComponent as CouponIcon} from "./coupon.svg?react";
import {ReactComponent as PercentIcon} from "./percent.svg?react";
import {ReactComponent as ProductListIcon} from "./qr-code-icon.svg?react";
import {ReactComponent as PaymentIcon} from "./payment-card.svg?react";
import {ReactComponent as OrderIcon} from "./orders.svg?react";
import {ReactComponent as AppFeedbackIcon} from "./app-feedback.svg?react";
import {ReactComponent as OtherChargesIcon} from "./other-charges.svg?react";
import {ReactComponent as MenuIcon} from "./menu-svg.svg?react";
