...
>(
  ...
  async (
    ...
    try {
      ...
      if (type === 'buyer') {
        endpoint = search ? 'cms/feedbackRoutes/getallbuyerfeedback' : 'cms/feedbackRoutes/getallbuyerfeedback';
      } else {
        endpoint = 'cms/dealerfeedbackRoutes/all';
      }
...
>(
  ...
  async (
    ...
    try {
      ...
      const endpoint =
        type === 'buyer'
          ? 'cms/feedbackRoutes/getallbuyerfeedback'
          : 'cms/dealerfeedbackRoutes/all';
    ...
    try {
      const endpoint =
        type === 'buyer'
          ...
          : `cms/dealerfeedbackRoutes/${id}/isdelete`;
