...
export const fetchTicketById = createAsyncThunk(
  'societysupportticket/fetchById',
...
export const fetchsupportticket = createAsyncThunk(
  'societysupportticket/fetchsupportticket',
  async (
    {
      search = '',
      filters = {},
...
export const deleteItem = createAsyncThunk(
  'societysupportticket/deleteItem',
...
export const updateTicketStatus = createAsyncThunk(
  'societysupportticket/updateStatus',
  async (
...
export const sendMessageToTicket = createAsyncThunk(
  'societysupportticket/sendMessage',
  async (
    {
      id,
      userType,
...
const SocietySupportTicketManagementSlice = createSlice({
  name: 'societysupportticket',
  initialState,
  reducers: {},
...
export default SocietySupportTicketManagementSlice.reducer;